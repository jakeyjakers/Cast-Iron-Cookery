...
const RecipeDetails = () => {
  ...
  const favoriteHandler = () => {
    axios
      .post(
        `${CASTIRON_COOKERY_API}/recipe/favorite`,
        { recipeId: id, userId: userId },
        {
          headers: {
            authorization: token,
          },
      ...
      .catch((error) => {
        ...
        console.log(error);
        alert(
          `Whoops! There was a problem favoriting this recipe. Try again later.`
        );
      });
  };
  ...
  useEffect(() => {
    ...
    axios
      ...
      .catch((error) => {
        ...
        console.log(error);
        alert(
          `Whoops! There was a problem grabbing this recipe. Try again later.`
        );
      });
  }, [id]);
  console.log(recipe);
